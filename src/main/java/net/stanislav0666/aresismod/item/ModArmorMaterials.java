...
public enum ModArmorMaterials implements ArmorMaterial {
    LIGHT_CULTIST("light_cultist", 26, new int[]{ 5, 7, 5, 4 }, 25,
            SoundEvents.ARMOR_EQUIP_GOLD, 1f, 0f, () -> Ingredient.of(ModItems.MOONSILVER_INGOT.get()));
    ...
    public String getName() {
        return AresisMod.MODID + ":" + this.name;
    }
